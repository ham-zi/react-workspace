      ...
      <div class="relative bg-gray-900">
        ...
        <div class="mx-auto px-4 py-4 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-8">
          <div class="relative max-w-2xl sm:mx-auto sm:max-w-xl sm:text-center md:max-w-2xl">
            <h2 class="mb-6 text-center font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
              Effortless Issue Tracking
            </h2>
            <p class="mb-8 text-center text-base text-indigo-200 md:text-lg">
            ...
            <a href="/add">
              <svg
                class="ml-2 inline h-6 w-6 text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
